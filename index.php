...
<script>
    ...
    $rootName = urldecode($_SERVER['HTTP_HOST']);
    $url = urldecode("{$_SERVER['REQUEST_URI']}");
    $directoryUrl = urldecode(__DIR__ . "$url");
...
<body class="bg-light">
    <div class="nav-scroller bg-white navbar-white shadow" style="position: fixed; top: 0; width: 100%; z-index: 1000">
        <nav class="nav nav-underline" aria-label="breadcrumb">
            <a class="navbar-brand breadcrumb-item active" style="padding-left: 15px;" href="<?php echo $root ?>"><?php echo $rootName ?></a>
            <?php
            $arrayBC = explode("/", $url);
            ...
            foreach ($arrayBC as $urls) {
                ...
                if ($end != $urls && $urls != "") {
            ?>
                    <a <?php if ($ab != $urls) { ?> href="<?php echo $root . $BCurls; ?>" <?php $status = "active";
                                                                                        } else {
                                                                                            $status = "text-muted";
                                                                                        } ?> style="background: transparent; padding-left: 5px; padding-right: 5px;" class="nav-link breadcrumb-item <?php echo $status ?>"><?php echo $urls;
                                                                                                                                                                                                                            ?></a>
            <?php
                }
            }
        ...
        <div class="row">
            <div class="col">
                <button id="php" class="btn d-flex align-items-center p-3 my-3 text-white-50 bg-info rounded-left box-shadow" style="width: 100%">
                    <div class="p-2">
                        <img class="mr-3" src="<?php echo $root ?>/assets/image/php-logo.svg" alt="PHP" width="90" height="90">
                    </div>
                ...
                <div class="card rounded box-shadow" id="cardItems">
                            ...
                            if (is_dir($directoryUrl . $file)) {
                                if ($file == "." or $file == "..") {
                                    ...
                                    <div class="searchableItem" id="<?php echo $file ?>" style="padding-bottom: 20px">
                                        <div class="card">
                                            <div class="card-body">
                                                <img src="<?php echo $root ?>/assets/image/icons/folder.svg" style="width: 45px; height: 45px">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div class="btn-group">
                                                        <button type="button" class="btn btn-sm btn-outline-secondary text-dark" disabled>
                                                            <script>
                                                                document.write(bytesToSize(<?php echo directorySize($directoryUrl . $file) ?>));
                                                            </script>
                                                        </button>
                                                        <button type="button" class="btn btn-sm btn-outline-secondary text-dark" disabled><?php echo directoryItems($directoryUrl . $file) . " items inside" ?></button>
                                                        <button type="button" class="btn btn-sm btn-outline-secondary text-dark" disabled><span data-livestamp="<?php echo filemtime($directoryUrl . $file) ?>"></span></button>
                                                    </div>
                    ...
                    <div class="card-footer d-block text-center mt-3">
                        <div class="text-muted">
                            <script>
                                document.write(bytesToSize(<?php echo $dt ?>));
                            </script> total
            ...
            <div class="col">
                <div class="card rounded box-shadow cardItems">
                    ...
                    <div class="container">
                        ...
                        ?>
                                <div class="searchableItem" id="<?php echo $file ?>" style="padding-bottom: 20px">
                                    <div class="card">
                                        <div class="card-body">
                                            <img src="<?php echo $root ?>/assets/image/icons/file.svg" style="width: 45px; height: 45px" alt="">
                                            <a href="<?php echo $file ?>"><?php echo $file ?></a>
                                        </div>
                                        <div class="card-footer">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="btn-group">
                                                    <button type="button" class="btn btn-sm btn-outline-secondary text-dark" disabled>
                                                        <script>
                                                            document.write(bytesToSize(<?php echo filesize($directoryUrl . $file); ?>));
                                                        </script>
                                                    </button>
                                                    <button type="button" class="btn btn-sm btn-outline-secondary text-dark" disabled>
                                                        <span data-livestamp="<?php echo filemtime($directoryUrl . $file) ?>"></span></button>
                    ...
                    <div class="card-footer d-block text-center mt-3">
                        <div class="text-muted">
                            <script>
                                document.write(bytesToSize(<?php echo $fs ?>));
                            </script> total
    ...
    <script>
        window.jQuery || document.write('<script src="<?php echo $root ?>/assets/js/jquery.min.js"><\/script>')
    </script>
